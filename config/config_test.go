	...
	Convey("Given an environment with no environment variables set", t, func() {
		...
		Convey("When the config values are retrieved", func() {
			...
			Convey("Then the values should be set to the expected defaults", func() {
				So(cfg.BindAddr, ShouldEqual, ":26100")
				...
				So(cfg.KafkaConfig.InstanceStartedGroup, ShouldEqual, "dp-import-cantabular-dataset")
				So(cfg.KafkaConfig.InstanceStartedTopic, ShouldEqual, "cantabular-dataset-instance-started")
