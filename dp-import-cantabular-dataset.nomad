job "dp-import-cantabular-dataset" {
  ...
  group "web" {
    ...
    task "dp-import-cantabular-dataset-web" {
      driver = "docker"
      ...
      vault {
        policies = ["dp-import-cantabular-dataset-web"]
      }
    }
  }
  ...
  group "publishing" {
    ...
    task "dp-import-cantabular-dataset-publishing" {
      driver = "docker"
      ...
      vault {
        policies = ["dp-import-cantabular-dataset-publishing"]
      }
    }
  }
}